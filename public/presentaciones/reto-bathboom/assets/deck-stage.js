...
(() => {
  ...
  const stylesheet = `
    ...
    /* ── Mobile (≤640px): esta presentación usa flex:1 sobre un canvas fijo
       de 1080px (sin las reglas de reflow mobile de otras plantillas), así
       que en vez de reconvertir a flujo estático — que deja secciones en
       blanco cuando su alto pasa a "auto" — simplemente se sigue escalando
       el canvas fijo hacia abajo (igual que en desktop) y solo se esconde
