...
export const DocViewerPage: React.FC = () => {
  ...
  const title = findTitle(course, src) ?? 'Documento del curso';
...
// Deriva el título del documento a partir del material del curso que coincide
// con el src; si no hay coincidencia, el visor usa un rótulo genérico.
const findTitle = (
