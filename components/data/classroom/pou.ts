...
const pouCronograma: CronogramaEntry[] = [
  {
    date: '2026-01-20',
    day: 'Martes',
    week: 1,
    topic: 'Introducción al curso',
    details: ['Presentación del proyecto', 'Metodología de trabajo', 'Sistema de evaluación'],
  },
  {
    date: '2026-01-22',
    day: 'Jueves',
    week: 1,
    topic: 'Equipos de trabajo, matriz de coevaluación, contrato cumplimiento de trabajo',
  },
  {
    date: '2026-01-26',
    day: 'Lunes',
    week: 2,
    topic: 'Introducción al proyecto máquinas virtuales',
  },
  {
    date: '2026-01-27',
    day: 'Martes',
    week: 2,
    topic: 'Diagramas de Ingeniería I',
    details: ['Quiz 1', 'PBD y PFD', 'Simbología estándar'],
    quiz: 'Quiz 1',
  },
  {
    date: '2026-01-29',
    day: 'Jueves',
    week: 2,
    topic: 'Taller de Diagramas',
    details: ['Taller 1: Diagramas completos', 'De PBD', 'Aplicación al proyecto'],
    taller: 'Taller 1',
  },
  {
    date: '2026-02-02',
    ...
    details: ['Diagramas en ingeniería', 'Bibliotecas de símbolos', 'Ejercicios prácticos'],
  },
  {
    date: '2026-02-03',
    day: 'Martes',
    week: 3,
    topic: 'Propiedades de Sólidos',
    details: ['Quiz 2', 'Caracterización', 'Distribución de tamaños', 'Teoría de molienda', 'Tipos de molinos'],
    quiz: 'Quiz 2',
  },
  {
    date: '2026-02-05',
    day: 'Jueves',
    week: 3,
    topic: 'Taller de Molienda',
    details: ['Taller 2: Cálculos de potencia', 'Leyes de molienda', 'Selección de equipos'],
    taller: 'Taller 2',
    proyecto: 'Entrega Bitácora 1: Domingo 8 de febrero 11:59 pm',
  },
  {
    date: '2026-02-09',
    day: 'Lunes',
    week: 4,
    topic: 'Introducción a Aspen Plus',
  },
  {
    date: '2026-02-10',
    day: 'Martes',
    week: 4,
    topic: 'Flujo de Fluidos',
    details: ['Quiz 3', 'Repaso Bernoulli', 'Pérdidas mayores y menores'],
    quiz: 'Quiz 3',
    proyecto: 'Coevaluación bitácora 1: Lunes 9 febrero 11:59 pm',
  },
  {
    date: '2026-02-12',
    day: 'Jueves',
    week: 4,
    topic: 'RETROALIMENTACIÓN 1',
    details: ['Sesiones por equipo (15 min)', 'Revisión de avances', 'Orientación del proyecto'],
    proyecto: 'Retroalimentación Entrega 1',
  },
  {
    date: '2026-02-16',
    day: 'Lunes',
    week: 5,
    topic: 'Introducción a Aspen Plus 2',
  },
  {
    date: '2026-02-17',
    day: 'Martes',
    week: 5,
    topic: 'Taller de Bernoulli',
    details: ['Taller 3: Cálculos de pérdidas', 'Sistemas de tuberías', 'Casos complejos'],
    taller: 'Taller 3',
  },
  {
    date: '2026-02-19',
    ...
    details: ['Quiz 4', 'Curvas características', 'NPSH y cavitación'],
    quiz: 'Quiz 4',
  },
  {
    date: '2026-02-23',
  ...
  },
  {
    ...
    week: 6,
    topic: 'Agitación',
    details: ['Quiz 5', 'Teoría de agitación', 'Tipos de impulsores'],
    quiz: 'Quiz 5',
  },
  {
    date: '2026-02-26',
    day: 'Jueves',
    week: 6,
    topic: 'Mezclado y Escalado',
    details: ['Quiz 6', 'Patrones de flujo', 'Criterios de escalado'],
    quiz: 'Quiz 6',
  },
  {
    date: '2026-03-02',
    day: 'Lunes',
    week: 7,
    topic: 'Bombas en Aspen Plus y tratamiento de fluidos no convencionales',
  },
  {
    date: '2026-03-03',
    day: 'Martes',
    week: 7,
    topic: 'Taller Agitación/Mezclado',
    details: ['Taller 4: Diseño de agitadores', 'Potencia y número de Reynolds', 'Aplicación a fermentadores'],
    taller: 'Taller 4',
  },
  {
    date: '2026-03-05',
    day: 'Jueves',
    week: 7,
    topic: 'Intercambiadores I',
    details: ['Quiz 7', 'Fundamentos', 'Método LMTD'],
    quiz: 'Quiz 7',
    proyecto: 'Entrega Bitácora 2: Domingo 8 de marzo 11:59 pm',
  },
  {
    date: '2026-03-09',
    day: 'Lunes',
    week: 8,
    topic: 'Intercambiadores en Aspen Plus',
  },
  {
    date: '2026-03-10',
    day: 'Martes',
    week: 8,
    topic: 'Intercambiadores II',
    details: ['Método Efectividad-NTU', 'Selección de equipos', 'Taller 5: Diseño térmico'],
    taller: 'Taller 5',
    proyecto: 'Coevaluación bitácora 2: Lunes 9 marzo 11:59 pm',
  },
  {
    date: '2026-03-12',
    day: 'Jueves',
    week: 8,
    topic: 'RETROALIMENTACIÓN 2',
    details: ['Revisión Entrega 2', 'Feedback detallado', 'Ajustes necesarios'],
    proyecto: 'Retroalimentación Entrega 2',
  },
  {
    date: '2026-03-23',
    day: 'Lunes',
  ...
  },
  {
    ...
    week: 10,
    topic: 'Filtración I',
    details: ['Quiz 8', 'Teoría de filtración', 'Resistencia de la torta'],
    quiz: 'Quiz 8',
  },
  {
    date: '2026-03-26',
    day: 'Jueves',
    week: 10,
    topic: 'Taller de Filtración',
    details: ['Taller 6: Diseño de filtros', 'Filtros rotatorios', 'Filtros prensa'],
    taller: 'Taller 6',
  },
  {
    date: '2026-04-06',
    day: 'Lunes',
    week: 12,
    topic: 'Destilación en Aspen Plus',
  },
  {
    date: '2026-04-07',
    day: 'Martes',
    week: 12,
    topic: 'Destilación I',
    details: ['Quiz 9', 'Equilibrio líquido-vapor', 'Volatilidad relativa'],
    quiz: 'Quiz 9',
  },
  {
    date: '2026-04-09',
    day: 'Jueves',
    week: 12,
    topic: 'Destilación II',
    details: ['Quiz 10', 'Destilación flash', 'Destilación diferencial'],
    quiz: 'Quiz 10',
    proyecto: 'Entrega Bitácora 3: Domingo 12 de abril 11:59 pm',
  },
  {
    date: '2026-04-13',
    day: 'Lunes',
    week: 13,
    topic: 'Planta completa Aspen',
  },
  {
    date: '2026-04-14',
    day: 'Martes',
    week: 13,
    topic: 'McCabe-Thiele I',
    details: ['Quiz 11', 'Construcción del diagrama', 'Líneas de operación'],
    quiz: 'Quiz 11',
    proyecto: 'Coevaluación: Lunes 13 de abril 11:59 pm',
  },
  {
    date: '2026-04-16',
    day: 'Jueves',
    week: 13,
    topic: 'RETROALIMENTACIÓN 3',
    details: ['Revisión integral', 'Preparación Entrega 4', 'Resolución de dudas'],
    proyecto: 'Retroalimentación Entrega 3',
  },
  {
    date: '2026-04-20',
    day: 'Lunes',
    week: 14,
    topic: 'Sesión de revisión de PFD',
  },
  {
    date: '2026-04-21',
    day: 'Martes',
    week: 14,
    topic: 'McCabe-Thiele II',
    details: ['Reflujo mínimo y óptimo', 'Localización del plato de alimentación', 'Taller 7: Destilación Flash Multicomponente'],
    taller: 'Taller 7',
  },
  {
    date: '2026-04-23',
    day: 'Jueves',
    week: 14,
    topic: 'Diseño de Platos',
    details: ['Quiz 12', 'Tipos de platos', 'Hidráulica de platos'],
    quiz: 'Quiz 12',
  },
  {
    date: '2026-04-27',
  ...
  },
  {
    ...
    day: 'Martes',
    week: 15,
    topic: 'Eficiencias en Destilación',
    details: ['Quiz 13', 'Eficiencia de Murphree', 'Altura de la torre'],
    quiz: 'Quiz 13',
  },
  {
    date: '2026-04-30',
    day: 'Jueves',
    week: 15,
    topic: 'Columnas Empacadas',
    details: ['Quiz 14', 'Tipos de empaque', 'HETP y diseño'],
    quiz: 'Quiz 14',
  },
  {
    date: '2026-05-04',
    day: 'Lunes',
    week: 16,
    topic: 'Trabajo autónomo',
  },
  {
    date: '2026-05-05',
    day: 'Martes',
    week: 16,
    topic: 'Taller Integral Destilación',
    details: ['Taller 8: Diseño completo', 'Selección platos vs empaque', 'Optimización económica'],
    taller: 'Taller 8',
  },
  {
    date: '2026-05-07',
  ...
  },
  {
    ...
    week: 17,
    topic: 'Taller Integral Destilación',
    details: ['Taller 9: Diseño completo', 'Selección platos vs empaque', 'Optimización económica'],
    taller: 'Taller 9',
  },
  {
    date: '2026-05-14',
    ...
    week: 17,
    topic: 'Trabajo autónomo',
    proyecto: 'Entrega Bitácora 4: Domingo 17 de mayo 11:59 pm',
  },
  {
    date: '2026-05-19',
    day: 'Martes',
    week: 18,
    topic: 'RETROALIMENTACIÓN 4',
    details: ['Revisión final por equipos', 'Últimos ajustes', 'Preparación presentaciones'],
    proyecto: 'Coevaluación: Lunes 19 de mayo 11:59 pm',
  },
  {
    date: '2026-05-21',
    day: 'Jueves',
    ...
    topic: 'RETROALIMENTACIÓN 4',
    details: ['Revisión final por equipos', 'Últimos ajustes', 'Preparación presentaciones'],
    proyecto: 'Retroalimentación Entrega 4',
  },
  {
    date: '2026-05-26',
    day: 'Martes',
    week: 19,
    topic: 'Sesión de pósters',
    proyecto: 'Coevaluación Póster y documento final',
  },
];
...
export const pouCourse: Course = {
  ...
  bannerUrl: '/classroom/iqya-2031/banner.jpg',
  pillars: [
    {
      title: 'Innovación',
      description:
