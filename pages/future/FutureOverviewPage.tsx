...
export const FutureOverviewPage = () => {
  ...
  const futureItems = [
    {
      title: t('future.pioneering.title'),
      description: t('future.pioneering.desc'),
      icon: (
    ...
    {
      title: t('future.collab.title'),
      description: t('future.collab.desc'),
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: t('future.mentoring.title'),
      description: t('future.mentoring.desc'),
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="pt-16">
            <div className="sticky top-16 bg-zinc-50/95 backdrop-blur-sm z-20 py-6 border-b border-zinc-200">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-brand-dark text-left">{t('future.overview.title')}</h1>
                    <p className="mt-4 text-brand-gray leading-relaxed">
                        {t('future.overview.sub')}
                    </p>
                </div>
            </div>
