export const research = {
  ...
  'stats.grants.note':      { en: 'currently active',         es: 'vigentes' },
  'stats.mentees.note':     { en: 'already graduated',       es: 'ya graduados' },
  'stats.avgEvaluation.runs':{ en: 'course runs evaluated',   es: 'cursos evaluados' },
  'stats.editorialBoards':  { en: 'Editorial Boards',        es: 'Comités Editoriales' },
  'stats.editorialBoards.note': { en: 'Subject Editor at Education for Chemical Engineers', es: 'Subject Editor en Education for Chemical Engineers' },
  'stats.leadershipRoles':  { en: 'Leadership Roles',        es: 'Roles de Liderazgo' },
  'stats.committees':       { en: 'Committees and Academies', es: 'Comités y Academias' },
  'stats.committees.note':  { en: 'Includes Academia Joven de Colombia', es: 'Incluye la Academia Joven de Colombia' },
  'stats.outreach':         { en: 'Outreach Activities',     es: 'Actividades de Divulgación' },
  ...
  'stats.moocLearners.note':{ en: 'completed',                es: 'completaron' },
